...
class Window:
    ...
    def __init__(self, info):
        ...
        self.map[self.goal2[0], self.goal2[1]] = 4000
    ...
    def draw_char(self, screen):
        ...
        mensaje = fuente.render("L", 1, (255, 255, 255))
    ...
    def draw_field(self, screen):
        ...
        mensaje2 = fuente.render("GL", 1, (0, 0, 0))
        screen.blit(mensaje2, (116 + self.goal[1]*55, 43 + self.goal[0]*55))

        mensaje2 = fuente.render("GR", 1, (0, 0, 0))
        screen.blit(mensaje2, (114 + self.goal2[1]*55, 43 + self.goal2[0]*55))
    ...
    def draw_items(self, screen):
        ...
        for item in self.items:
            if item[2] == 5:
                ...
                fuente = pygame.font.Font(None, 25)
                mensaje = fuente.render("R", 1, (255, 255, 255))
